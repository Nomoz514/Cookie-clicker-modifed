	...
	Game.Init=function()
	{
		...
		*/
		...
		Game.mouseCps=function()
		{
			...
			if (Game.Has('Unobtainium mouse')) add+=Game.cookiesPs*3.1;
			if (Game.Has('Eludium mouse')) add+=Game.cookiesPs*3.1;
			if (Game.Has('Wishalloy mouse')) add+=Game.cookiesPs*3.1;
			if (Game.Has('Fantasteel mouse')) add+=Game.cookiesPs*3.1;
