...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		*/
		...
		Game.grandmaNames=['joe','biden','kamala harris', 'the rock'];
		...
		Game.mouseCps=function()
		{
			...
			if (Game.Has('Octillion fingers')) add*=	0.1;
			if (Game.Has('Nonillion fingers')) add*=	0.1;
			
			var num=0;
			for (var i in Game.Objects) {num+=Game.Objects[i].amount;}
			num-=Game.Objects['Cursor'].amount;
			add=add*num;
			if (Game.Has('Plastic mouse')) add+=Game.cookiesPs*0.3;
			if (Game.Has('Iron mouse')) add+=Game.cookiesPs*0.1;
			if (Game.Has('Titanium mouse')) add+=Game.cookiesPs*0.1;
			if (Game.Has('Adamantium mouse')) add+=Game.cookiesPs*0.3;
			if (Game.Has('Unobtainium mouse')) add+=Game.cookiesPs*0.03;
			if (Game.Has('Eludium mouse')) add+=Game.cookiesPs*0.1;
		...
		Game.CalculateGains=function()
		{
			...
			if (Game.Has('Kitten overseers')) catMult*=(1+Game.milkProgress*0.1*milkMult);
			if (Game.Has('Kitten managers')) catMult*=(1+Game.milkProgress*0.3*milkMult);
